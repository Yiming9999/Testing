...
class PaymentIntegrationTest {
    ...
    void itShouldCreatePaymentSuccessfully() throws Exception {
        ...
        ResultActions customerRegResultActions = mockMvc.perform(put("/api/v1/customer-registration")
                ...
                .content(Objects.requireNonNull(objectToJason(customerRegistrationRequest))));
        ...
        ResultActions paymentResultActions = mockMvc.perform(post("/api/v1/payment")
                .contentType(MediaType.APPLICATION_JSON)
                .content(Objects.requireNonNull(objectToJason(paymentRequest))));
        ...
        assertThat(paymentRepository.findById(paymentId))
                ...
                .hasValueSatisfying(p -> {
                    ...
                    assertThat(p.getAmount().intValue()).isEqualTo(payment.getAmount().intValue());
    ...
    private String objectToJason(Object object) {
        try {
